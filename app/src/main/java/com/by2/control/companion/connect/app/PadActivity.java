...
public class PadActivity extends UartInterfaceActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExtendButton.setOnTouchListener(mPadButtonTouchListener);
        Button RetractButton = (Button) findViewById(R.id.RetractButton);
        RetractButton.setOnTouchListener(mPadButtonTouchListener);
    ...
    View.OnTouchListener mPadButtonTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                return true;
            } else if ((event.getAction() == MotionEvent.ACTION_UP) && (tag != 40)) {
                view.setPressed(false);
                sendTouchEvent(2, true);
                return true;
            }
            return false;
        }

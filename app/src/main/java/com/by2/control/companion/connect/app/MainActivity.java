...
import com.by2.control.companion.connect.app.settings.SettingsActivity;
import com.by2.control.companion.connect.app.update.FirmwareUpdater;
import com.by2.control.companion.connect.app.update.ReleasesParser;
import com.by2.control.companion.connect.ble.BleDevicesScanner;
import com.by2.control.companion.connect.ble.BleManager;
import com.by2.control.companion.connect.ble.BleUtils;
import com.by2.control.companion.connect.ui.utils.DialogUtils;
...
*/
    ...
    public void onClickDeviceConnect(View view) {
        ...
        if (scannedDeviceIndex < mScannedDevices.size()) {
            ...
            if (mSelectedDeviceData.type == BluetoothDeviceData.kType_Uart) {      // if is uart, show all the available activities
                // edit 2016-09-22 12:04 AM
                //showChooseDeviceServiceDialog(mSelectedDeviceData);
                // bypassed picker popup
                // added below method to enter directly into controller mode
                enterControllerMode(mSelectedDeviceData);
    ...
    private void enterControllerMode (final BluetoothDeviceData deviceData) {
        mComponentToStartWhenConnected = ControllerActivity.class;
...
/*
    Information deleted from the XML

...
public class FourthPadActivity extends UartInterfaceActivity  {
    // Log
    private final static String TAG = FourthPadActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // UI
        Button UpStairs = (Button) findViewById(R.id.upStairs);
        UpStairs.setOnTouchListener(mPadButtonTouchListener);
        Button DownStairs = (Button) findViewById(R.id.downStairs);
        DownStairs.setOnTouchListener(mPadButtonTouchListener);
        Button StairsStop = (Button) findViewById(R.id.stairsStop);
        StairsStop.setOnTouchListener(mPadButtonTouchListener);

        Button UpRamp = (Button) findViewById(R.id.upRamp);
        UpRamp.setOnTouchListener(mPadButtonTouchListener);
        Button DownRamp = (Button) findViewById(R.id.downRamp);
        DownRamp.setOnTouchListener(mPadButtonTouchListener);
        Button RampStop = (Button) findViewById(R.id.rampStop);
        RampStop.setOnTouchListener(mPadButtonTouchListener);

        Button SitDown = (Button) findViewById(R.id.sitDown);
        SitDown.setOnTouchListener(mPadButtonTouchListener);
        Button StandUp = (Button) findViewById(R.id.standUp);
        StandUp.setOnTouchListener(mPadButtonTouchListener);
        Button StandStop = (Button) findViewById(R.id.standStop);
        StandStop.setOnTouchListener(mPadButtonTouchListener);
